...
public class ItemDeclaration {
    ...
    public static Map<String, ItemMenu> decItem(Scanner in, IParticipanteRepository participanteRepository, IProvaRepository provaRepository, IQuestaoRepository questaoRepository, UiConsole uiConsole, ITentativaRepository tentativaRepository, PontuacaoService pontuacaoService) {
        ...
        itemMenu.put("3", new CadastrarQuestaoItem(questaoRepository, provaRepository, uiConsole, in));
        itemMenu.put("4", new aplicarProvaItem(participanteRepository, questaoRepository, provaRepository, tentativaRepository, pontuacaoService, uiConsole, in));
